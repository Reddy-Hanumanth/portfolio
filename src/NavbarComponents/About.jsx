        ...
        <div className="group relative ">
          ...
          <div className="absolute bottom-6 -right-4 md:-right-10 bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-xl flex items-center gap-4 border border-gray-100">
            <div className="flex -space-x-2">
              ...
              <div className="w-8 h-8 rounded-full  border-2 border-white flex items-center justify-center text-[10px]">
                <i className="fa-brands fa-html5 text-blue-500 text-xl"></i>
              </div>
              <div className="w-8 h-8 rounded-full border-2 border-white flex items-center justify-center text-[10px]">
                <i className="fa-brands fa-python text-yellow-500 text-xl"></i>
              </div>
              <div className="w-8 h-8 rounded-full  border-2 border-white flex items-center justify-center text-[10px]">
                <i className="fa-solid fa-database text-blue-700 text-lg"></i>
              </div>
            </div>
            <div>
        ...
        <div className="max-w-xl flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4 text-lg  leading-relaxed text-gray-800/50">
            <p>
              ...
              and user-friendly web applications. I believe great software is
              defined by clarity, maintainability, and thoughtful
              problem-solving.
            </p>

            <p className="sm:block hidden">
              I work with the React ecosystem on the front end and build
              reliable backend logic, APIs, and databases to deliver complete
              end-to-end solutions. I enjoy turning complex ideas into simple,
              efficient systems.
            </p>

            <p className="sm:block hidden">
              Outside of development, I explore minimalist design, work on
              personal and open-source projects, and document my learning
              journey. I’m continuously improving my full-stack skills with a
              strong focus on growth and quality.
            </p>
          </div>
          <hr className="" />
          ...
          <div className="flex items-center justify-between ">
            <div>
              <h1 className="sm:text-4xl md:text-3xl text-2xl text-gray-500">
                5+
              </h1>
              <p className="text-gray-800/50 text-sm sm:text-base">
                Projects Completed
              </p>
            </div>
            <div className="">
