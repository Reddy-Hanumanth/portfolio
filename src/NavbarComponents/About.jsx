...
const About = () => {
  return (
    <div>
      ...
      <div className="flex flex-col space-y-6 max-w-[600px]">
        ...
        <div>
          <p className=" text-black/60">
            ...
            focus on writing efficient code, improving performance, and creating
            projects that feel modern and meaningful. I’m always learning,
            experimenting, and finding new ways to make the web a little more
            awesome.
          </p>
        </div>
      </div>
      <div className="flex flex-col gap-4 py-4 justify-center">
        <h4 className="text-lg font-bold  dark:text-slate-50">My Toolkit</h4>
      ...
      <div className='flex felx-wrap space-x-4'>
        <button className="bg-purple-500 px-3 py-2 mt-10 rounded cursor-pointer hover:bg-opacity-90 text-white transition hover:-translate-y-2 duration-300 eas-in hover:shadow-2xl">
          <Link to="/contact">Say Hello!</Link>
        </button>
        <button className="bg-purple-500 px-3 py-2 mt-10 rounded cursor-pointer hover:bg-opacity-90 text-white transition hover:-translate-y-2 duration-300 eas-in hover:shadow-2xl">
          <Link to="https://github.com/Reddy-Hanumanth"><i className="fa-brands fa-github"></i>    Github</Link>
        </button>
        <button className="bg-purple-500 px-3 py-2 mt-10 rounded cursor-pointer hover:bg-opacity-90 text-white transition hover:-translate-y-2 duration-300 eas-in hover:shadow-2xl">
          <Link to="https://www.linkedin.com/feed/"><i className="fa-brands fa-square-linkedin"></i>   Linkedin</Link>
        </button>
      </div>
    </div>
    </div>
